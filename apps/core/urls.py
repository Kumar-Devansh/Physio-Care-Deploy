...
urlpatterns = [
    ...
    path("care-summary/", views.patient_care_summary_pdf, name="patient_care_summary_pdf"),
    path(
    ...
    path(
        "doctor/patients/<int:pk>/summary/",
        views.patient_care_summary_pdf,
        name="doctor_patient_care_summary_pdf",
    ),
